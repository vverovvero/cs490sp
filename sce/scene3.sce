...
INCLUDE Mesh(geometry/sce/humanoid.sce) Material(2) Scale(3, 3, 3) RotateY(30) Translate(10, 10, 20) 
INCLUDE Mesh(geometry/sce/humanoid.sce) Material(2) Scale(3, 3, 3) RotateY(30) Translate(25, 10, 35) 
INCLUDE Mesh(geometry/sce/humanoid.sce) Material(2) Scale(3, 3, 3) RotateY(30) Translate(40, 10, 50) 
INCLUDE Mesh(geometry/sce/humanoid.sce) Material(2) Scale(3, 3, 3) RotateY(30) Translate(55, 10, 65) 
INCLUDE Mesh(geometry/sce/humanoid.sce) Material(2) Scale(3, 3, 3) RotateY(30) Translate(70, 10, 80) 
INCLUDE Mesh(geometry/sce/humanoid.sce) Material(2) Scale(3, 3, 3) RotateY(30) Translate(85, 10, 95) 
#INCLUDE Mesh(sce/bunny.sce) Material(2) Scale(3, 3, 3) Rotate(0, 20, 0) Translate(100, 10, 110) 