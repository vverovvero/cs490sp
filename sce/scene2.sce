...
#INCLUDE Mesh(geometry/sce/humanoid.sce) Material(2) Scale(3, 3, 3) RotateY(30) Translate(50, 10, 80) 
#INCLUDE Mesh(geometry/sce/bunny.sce) Material(2) Scale(3, 3, 3) RotateY(30) Translate(50, 10, 80) 


#Enlarge the bunny more
INCLUDE Mesh(geometry/sce/bunny.sce) Material(2) Scale(14, 14, 14) RotateY(15) Translate(50, 30, 80) 